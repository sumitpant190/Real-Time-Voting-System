...
# Set environment variables for Spark to use the correct Python interpreter
os.environ['PYSPARK_PYTHON'] = 'E:/data engineering projects/Real Time Voting System/venv/Scripts/python.exe'
os.environ['PYSPARK_DRIVER_PYTHON'] = 'E:/data engineering projects/Real Time Voting System/venv/Scripts/python.exe'
...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder \
            ...
            .config('spark.jars','E:/data engineering projects/Real Time Voting System/postgresql-42.7.3.jar')  # postgres sql driver 
    ...
    # Aggregate votes_per candidate and turnout by location
    ...
    votes_per_candidate_to_kafka = (votes_per_candidate.selectExpr('to_json(struct(*)) AS value')
                            ...
                            .option('checkpointLocation', r'E:\data engineering projects\Real Time Voting System\checkpoints\checkpoint1')
                            .outputMode('update')
                            .start()
                             )
    ...
    turnout_by_location_to_kafka = (turnout_by_location.selectExpr('to_json(struct(*)) AS value')
                            ...
                            .option('checkpointLocation', r'E:\data engineering projects\Real Time Voting System\checkpoints\checkpoint2')
                            .outputMode('update')
                            .start()
                             )    
    
    # Await termination for the straming queries
